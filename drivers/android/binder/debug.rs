...
#[no_mangle]
pub(crate) static rust_binder_debug_mask: AtomicU32 = AtomicU32::new(
...
pub(crate) fn debug_mask_enabled(mask: DebugMask) -> bool {
    let current_mask = rust_binder_debug_mask.load(Ordering::Relaxed);
